...
As a final note, ACLED does not capture all conflict. We use the number of fatalities per 100,000 that we have calculated from their dataset for comparisons between countries. Were we looking for the actual mortality rate, there are [preferred sources](https://www.who.int/data/gho/data/themes/mortality-and-global-health-estimates/ghe-leading-causes-of-death).
