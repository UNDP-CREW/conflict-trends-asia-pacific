...
## 1. Introduction and broad trends 
...
Furthermore, all have populations who actively participate in the political process -- even the least protest-inclined of this group, Fiji and Japan, have higher rates of participation (i.e. number of events per 100k) than Indonesia or Malaysia, or even pre-2024 Bangladesh. 
...
### 1.1 Conflict events and fatalities (summary tables)
...
Afghanistan saw the largest decline in political conflict, followed by Vietnam. Myanmar, Indonesia, Iran and Bangladesh have each experienced a significant increase in unrest in the past five years. As mentioned before, though countries like South Korea and Japan also large increases in political conflict, these activities were not associated with any deaths. 
...
As mentioned, the increase in the number of conflict events -- especially if they were primarily due to protests -- is not an immediate cause for concern. South Koreans have managed to enact several changes through their protests (like the removal of President Park Geun-hye), as have Malaysians and Nepalese. 

With reference to the trendlines in @fig-eventsfatalitiesline, conflict fatalities are down for almost all countries. However, just like an increase in conflict events is not always associated with an increases in injustice and violence, a reduction in political conflict only indicates stabilisation or suppression, not that any underlying issues have been resolved. 

Afghanistan, China, Vietnam, Cambodia, Laos, Hong Kong, Philippines and the Solomon Islands have each seen a drastic fall in conflict events and fatalities over the past 10 years. Fatalities in Pakistan and Bangladesh were trending upwards, at the end of 2023 (2024 has not yet concluded and for this comparison, we have elected to use only full years of data). 

The remaining countries each experience periodic spikes in conflict -- the clearest example of which is Iran where the crest of various protest movements is immediately visible. 

<br>

```{r events-fatalities-line, warning = FALSE, fig.height= 6.5}

#| label: fig-eventsfatalitiesline
...
acled_filtered |> 
  ...
  labs(title = "Political incident fatalities by country in descending order, 2014-2023", 
       subtitle = "Events are in dark blue, fatalities in red",
       y = "Annual fatalities", 
       x = "", 
       colour = "")
...
#### 1.2.1 Fatalities over time 

The charts below are streamgraphs, where values over time -- in the case below, quarterly conflict fatalities -- are represented by the area. Though there are negative values shown, the Y-axis values are absolute; a streamgraph makes spikes in violence (from elections, for instance) much more visible. 
...
Regional tensions, state overreach and bread and butter issues are the issues that people in the Asia-Pacific protested the most about. 

Though inflation seems to have been arrested, the poverty rate in these countries should be monitored very carefully. 

The predominance of bread-and-butter concerns like the economy and the basic service delivery still dominate
