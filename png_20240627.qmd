...
```{r}
viridis_pal(option = "magma")(4) |> show_col()
```
...
tracker |>
  ...
  labs(title = "Incidents by total casualties (dead and injured)", 
...
### Tracker words
Ultimately not necessary, but it
...
tracker_actors |> 
  ...
  filter(str_detect(actor, "Linapini"))
```
