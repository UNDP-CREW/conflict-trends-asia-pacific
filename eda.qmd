...
myammar_acled_2022 <- acled_filtered |> 
  ...
  geom_point(aes(x = longitude, y = latitude, 
                 colour = ged_violence_type,
                 size = fatalities), 
             alpha = .3) + 
  scale_colour_viridis_d(option = "viridis") +
  # scale_colour_manual(values = c("#7e03a8", "#21918c", "#fc8961")) + 
...
ggsave(here("plots", "myanmar_combined_2022.png"), dpi = 300, height = 16.5, width = 23.4, units = "in")
