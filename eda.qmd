...
roads_conflict_black_red <- roads_conflict_data |> 
  ggplot() +
  geom_sf(size = .1, colour = "grey30", fill = "", data = myanmar_adm1) + 
  ...
  geom_point(aes(x = 96.1735, y = 16.8409), size = 2.5,
             colour = "goldenrod2", pch = 15, alpha = .8) +
  # Monywa
  geom_point(aes(x = 95.1536, y = 22.1216), size = 2.5,
             colour = "goldenrod2", pch = 15, alpha = .8) +
  # Sittwe
  ...
  geom_text(aes(label = year_label), size = 9.5, 
           x = 93.041879, y = 28.735721, colour = "#FFF5EE") + 
  ...
  theme_void() + 
  theme(plot.background = element_rect(fill = "grey60", colour = NA),
...
protest_network_graph <- acled_protests |>
  ...
  geom_node_point(colour = "blue", alpha = 0.3, size = .5) +
