...
```{r}
myanmar_acled <- acled_filtered |> 
  filter(country == "Myanmar" & event_date >= "2021-02-01" & 
  ...
  mutate(diffdays = as.numeric(difftime(event_date, as.Date("2021-02-01"),
                                        unit = "days")), 
         inter_type = fct_relevel(
           inter_type,
...
ggsave(here("plots", "roads_conflict_new.png"), dpi = 300, height = 33.1, width = 17, units = "in")
