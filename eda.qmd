...
acled_filtered |> 
  ...
  labs(title = "Conflict fatalities by country in the Asia-Pacific in descending order, 2013-2023", 
...
acled_filtered |> 
  ...
  geom_area() + 
  scale_y_log10()
  geom_col(aes(fill = event_type), position = "stack")
  geom_area(aes(fill = event_type), position = "fill")
```
