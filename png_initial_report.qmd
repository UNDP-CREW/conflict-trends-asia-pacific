...
From the chart on conflict durations in [section 1](#inspecting-the-data), the duration does not seem to be a predictor of conflict casualties. Instead, incident descriptions seems to be more useful. 
